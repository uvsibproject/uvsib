...
class GRACECalculation(CalcJob):
    """AiiDA plugin for GRACE (https://github.com/ICAMS/grace-tensorpotential)."""
    ...
    def prepare_for_submission(self, folder):
        """Create input files for GRACE. Here, adding to the command line."""
